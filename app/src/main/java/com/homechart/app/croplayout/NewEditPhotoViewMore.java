 ...
 */
public class NewEditPhotoViewMore extends FrameLayout {
    ...
    public NewEditPhotoViewMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        obtainAttributes(context, attrs);
    }

    public NewEditPhotoViewMore(Context context, AttributeSet attrs, int defStyle) {
