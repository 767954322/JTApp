 ...
 * 自定义流式布局
 */
public class FlowLayoutCaiJiTags extends ViewGroup {

    private LayoutInflater mInflater;
    private boolean isColorful;

    public FlowLayoutCaiJiTags(Context context) {
        this(context, null);
    }

    public FlowLayoutCaiJiTags(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayoutCaiJiTags(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.i("test", "sizeHeight" + sizeHeight);
     ...
     * 设置数据
     */
    public void setListData(final List<TagListItemBean> list, final Map<String, String> selectMap, final String type) {
        if(selectMap != null ){
        ...
        for (int i = 0; i < count; i++) {
            ...
            tv.setText(list.get(i).getTag_info().getTag_name());
            tv_select.setText(list.get(i).getTag_info().getTag_name());

            if (mSelectMap != null && mSelectMap.containsKey(list.get(i).getTag_info().getTag_name())) {
            ...
            tv.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mSelectMap.put(list.get(finalI).getTag_info().getTag_name(), list.get(finalI).getTag_info().getTag_name());
                    tv.setVisibility(GONE);
                    tv_select.setVisibility(VISIBLE);
            ...
            tv_select.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mSelectMap.remove(list.get(finalI).getTag_info().getTag_name());
                    tv_select.setVisibility(GONE);
                    tv.setVisibility(VISIBLE);
                    if (onTagClickListener != null)
