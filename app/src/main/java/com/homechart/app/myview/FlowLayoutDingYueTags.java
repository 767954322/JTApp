 ...
 * 自定义流式布局
 */
public class FlowLayoutDingYueTags extends ViewGroup {

    private LayoutInflater mInflater;
    private boolean isColorful;

    public FlowLayoutDingYueTags(Context context) {
        this(context, null);
    }

    public FlowLayoutDingYueTags(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowLayoutDingYueTags(Context context, AttributeSet attrs, int defStyle) {
...
//        Log.i("test", "sizeHeight" + sizeHeight);
    ...
    public void setListData(final List<DYItemGroupItemBean> list, final int position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //1:订阅 2:没有：未订阅
            final TextView tv_dingyue_tag1 = (TextView) view.findViewById(R.id.tv_dingyue_tag1);
            final TextView tv_dingyue_tag = (TextView) view.findViewById(R.id.tv_dingyue_tag);
            final ImageView iv_dingyue_tag1 = (ImageView) view.findViewById(R.id.iv_dingyue_tag1);
