...
public class MyDialog extends PopupWindow implements View.OnClickListener {
    ...
    private InterDioalod mInterDioalod;
    private View view;
    ...
    public MyDialog(Context context, String content, InterDioalod interDioalod) {
...
//        this.setAnimationStyle(R.style.take_photo_anim);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.tv_quxiao) {
            mInterDioalod.onQuXiao();
        } else if (id == R.id.tv_queren) {
            mInterDioalod.onQueRen();
        }
    }
}
