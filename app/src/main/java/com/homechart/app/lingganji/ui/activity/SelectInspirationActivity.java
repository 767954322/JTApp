...
public class SelectInspirationActivity extends BaseActivity
        ...
        mAdapter = new MultiItemCommonAdapter<InspirationBean>(mContext, mListData, support) {
            ...
            public void convert(final BaseViewHolder holder, final int position) {
                ...
                if (TextUtils.isEmpty(mListData.get(position).getAlbum_info().getCover_image().getImg0())) {
                    GlideImgManager.glideLoader(SelectInspirationActivity.this, "", R.drawable.moren2, R.drawable.moren2, (ImageView) holder.getView(R.id.iv_item_pic));
                } else {
    ...
    protected void onResume() {
        ...
        MobclickAgent.onPageStart("灵感辑图片移动复制选择灵感辑页");
        Tracker t = MyApplication.getInstance().getDefaultTracker();
        // Set screen name.
        t.setScreenName("灵感辑图片移动复制选择灵感辑页");
        // Send a screen view.
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("灵感辑图片移动复制选择灵感辑页");
