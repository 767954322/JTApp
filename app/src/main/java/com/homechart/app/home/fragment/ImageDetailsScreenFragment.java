...
public class ImageDetailsScreenFragment
    ...
    public ImageDetailsScreenFragment() {
    }

    public ImageDetailsScreenFragment(FragmentManager fragmentManager , String item_id , String type , int mPosition, List<String> itemIdList) {
...
//                            mViewPager.setCurrentItem(mViewPager.getCurrentItem());
    ...
    public class MyImagePageAdater extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new NewImageDetaiScrollFragment(rootView,fragmentManager, mItemIdList.get(position), ImageDetailsScreenFragment.this, position);
        }
