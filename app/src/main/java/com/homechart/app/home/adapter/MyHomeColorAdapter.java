...
public class MyHomeColorAdapter extends BaseAdapter {
    ...
    public MyHomeColorAdapter(Context mContext, List<ColorItemBean> color_list, Map<Integer, ColorItemBean> selectColorMap) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == mColorlist.size()) {
            ...
            if (null != mSelectColorMap && mSelectColorMap.containsKey(mColorlist.get(position).getColor_id())) {
